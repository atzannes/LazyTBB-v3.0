...
template<typename Range, typename Body, typename Partitioner> class start_for_meld;
...
private:
    ...
    template<typename Range, typename Body, typename Partitioner> friend class internal::start_for_meld;
